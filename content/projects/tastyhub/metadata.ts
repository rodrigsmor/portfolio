...
export const fullTastyhub: Project = {
  ...
  fullDescription: {
    "en-US": `
      Tastyhub is a Full Stack project that simulates a complete recipe-sharing platform, developed with a focus on software engineering best practices and user experience.
      \n\n
    ...
    `,
    "pt-BR": `
      Tastyhub é um projeto Full Stack que simula uma plataforma completa de compartilhamento de receitas, desenvolvido com foco em boas práticas de engenharia de software e experiência do usuário.
      \n\n
    ...
    `,
    "es-419": `
      Tastyhub es un proyecto Full Stack que simula una plataforma completa para compartir recetas, desarrollado con un enfoque en las mejores prácticas de ingeniería de software y la experiencia del usuario.
      \n\n
