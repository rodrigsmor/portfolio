...
export const fullPeruTravel: Project = {
  ...peruTravell,
  technologies: [
    HTMLSkill,
    CSSSkill,
  ...
  fullDescription: {
    "en-US": `Peru Travel is an academic project developed to apply fundamental web development concepts in practice. The application was built using pure (vanilla) HTML, CSS, and JavaScript, without frameworks, strengthening the understanding of the web's core.
    ...
    "pt-BR": `Peru Travel é um projeto desenvolvido no contexto acadêmico com o objetivo de aplicar, na prática, os conceitos fundamentais do desenvolvimento web. A aplicação foi construída utilizando HTML, CSS e JavaScript puro (vanilla), sem o uso de frameworks, reforçando a compreensão da base da web.
    ...
    "es-419": `Peru Travel es un proyecto desarrollado en el contexto académico con el objetivo de aplicar, en la práctica, los conceptos fundamentales del desarrollo web. La aplicación fue construida utilizando HTML, CSS y JavaScript puro (vanilla), sin el uso de frameworks, reforzando la comprensión de la base de la web.
